...
formatter.step({
  "name": "digita el nombre del cliente a consultar Colombia en el campo búsqueda",
  "keyword": "When "
});
formatter.match({
...
formatter.step({
  "name": "se visualiza el nombre del cliente Colombia en el resultado de la búsqueda",
  "keyword": "Then "
});
formatter.match({
