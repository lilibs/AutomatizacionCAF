...
formatter.scenario({
  "name": "Cancelar la creación de un contacto",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "se ubica en el formulario de crear contactos",
  "keyword": "And "
});
formatter.match({
  "location": "CrearContactos.se_ubica_en_el_formulario_de_crear_contactos()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "presiona el botón Regresar de contactos",
  "keyword": "When "
});
formatter.match({
  "location": "CrearContactos.presiona_el_boton_Regresar_de_contactos()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "se visualiza nuevamente la página principal de contactos",
  "keyword": "Then "
});
formatter.match({
  "location": "CrearContactos.se_visualiza_nuevamente_la_pagina_principal_de_contactos()"
});
formatter.result({
  "status": "passed"
});
