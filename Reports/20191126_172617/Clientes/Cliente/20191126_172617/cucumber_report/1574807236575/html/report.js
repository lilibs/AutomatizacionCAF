...
formatter.step({
  "name": "digita el nombre del cliente a crear \u003cnombreClientes\u003e",
  "keyword": "When "
});
formatter.step({
...
formatter.step({
  "name": "el sistema muestra el mensaje de acuerdo a la acción realizada",
  "keyword": "Then "
});
formatter.examples({
  "name": "",
...
formatter.step({
  "name": "digita el nombre del cliente a crear Cliente",
  "keyword": "When "
});
formatter.match({
...
formatter.step({
  "name": "digita el BBG Broker ID 90",
  "keyword": "And "
});
formatter.match({
...
formatter.match({
  "location": "CrearCliente.el_sistema_muestra_el_mensaje_de_acuerdo_a_la_accion_realizada()"
});
formatter.result({
  "status": "passed"
});
