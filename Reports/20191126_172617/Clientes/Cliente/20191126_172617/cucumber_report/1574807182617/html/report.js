$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("E:/CAF/Automatizacion/CAF1/Include/features/IngresoApp/ValidarIngresoAppConAcceso.feature");
formatter.feature({
  "name": "Ingreso a la aplicación",
  "description": "  Yo como usuario con permisos de acceso deseo ingresar a la aplicación de Tesorería",
  "keyword": "Feature",
  "tags": [
    {
      "name": "@IngresoApp"
